    ...
    <div>
      ...
      <AvantaCard
        title={
          <>
            ADMINISTRAÇÃO{' '}
            <span className={styles.tituloPerfil}>· {perfil === 'administrador' ? 'Administrador' : 'Gestor'}</span>
          </>
        }
        ...
        {aba === 'visao' && (
          <div>
            ...
            <div className={styles.cardsGrid}>
              ...
              <div className={`${styles.statCard} ${styles.statTeal}`}><div className={styles.statLabel}>Baixado</div><div className={styles.statValue}>{formatarMoeda(resumo.baixado)}</div></div>
