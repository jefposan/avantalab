...
type Props = { colaborador: Colaborador; empresas: Empresa[]; subempresas: Subempresa[]; servicos: Servico[]; podeRegistrar: boolean; podeAgendar: boolean; onRegistrar: (empresaId: string, subempresaId: string | null, clienteNome: string, assinatura: string, avaliacao: AvaliacaoServico, observacao: string, servicoId?: string) => Promise<void> | void; onAgendar: (empresaId: string, subempresaId: string | null, data: string, tipo: Exclude<TipoServico, 'rotina'>) => Promise<void> | void; };

export default function PainelServicosColaborador({ colaborador, empresas, subempresas, servicos, podeRegistrar, podeAgendar, onRegistrar, onAgendar }: Props) {
