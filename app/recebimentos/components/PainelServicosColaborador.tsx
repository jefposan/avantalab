...
export default function PainelServicosColaborador({ colaborador, empresas, subempresas, servicos, podeRegistrar, podeAgendar, onRegistrar, onAgendar }: Props) {
  ...
  return <div className={styles.mobileWrap}>
    ...
    {sucesso && <div className={styles.sucessoServico} role="status"><b>Operação concluída.</b> O serviço foi atualizado e já está disponível para a gestão.</div>}
