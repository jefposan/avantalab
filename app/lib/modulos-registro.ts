...
export const REGISTRO_MODULOS: readonly RegistroModulo[] = [
  ...
  },
  {
    ...
    ordem: 2,
    superficies: ['web', 'pwa', 'android', 'ios'],
    navegacao: { modo: 'integrado', rotuloMenu: 'Conteúdo AvantaVendas' },
    comercial: { precoMensal: VALOR_MODULO_AVULSO_MENSAL, vendavelNoBusiness: true, incluidoNoBusinessPro: true },
    dados: { escopo: 'empresa', preservarAoRemover: true },
    permissoes: permissoesOperacionais,
  },
  {
    ...
    descricao: 'Recebimentos e serviços em campo, com conferência e acompanhamento pelo gestor.',
    icone: 'recebimentos',
    ordem: 3,
    superficies: ['web', 'pwa', 'android', 'ios'],
    navegacao: { modo: 'pagina_total', rotuloMenu: 'Operações de Campo', rota: '/recebimentos', retorno: '/gestao' },
    comercial: { precoMensal: VALOR_MODULO_AVULSO_MENSAL, vendavelNoBusiness: true, incluidoNoBusinessPro: true },
    dados: { escopo: 'empresa', preservarAoRemover: true },
    permissoes: permissoesOperacionais,
  },
  ...
  },
  {
    ...
    ordem: 6,
    superficies: ['web'],
    navegacao: { modo: 'pagina_total', rotuloMenu: 'Vendas e serviços', rota: '/vendas', retorno: '/gestao' },
    comercial: { precoMensal: VALOR_MODULO_AVULSO_MENSAL, vendavelNoBusiness: true, incluidoNoBusinessPro: true },
    dados: { escopo: 'empresa', preservarAoRemover: true },
    permissoes: permissoesOperacionais,
  },
