...
- A ativação de um perfil de Vendas não bloqueia os outros perfis acessíveis pelo mesmo usuário. O vínculo comercial continua único e independente da lista de perfis disponíveis.
...
- No card do cliente, a linha destacada do endereço abre Google Maps, Mapas Apple ou Waze. Se não houver endereço, a linha fica sem clique e orienta o usuário a cadastrá-lo.
