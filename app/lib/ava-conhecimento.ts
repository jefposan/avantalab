...
- Novo pedido pode iniciar em Clientes (cliente já definido) ou em Pedidos (selecionar cliente). No cadastro da cliente, Tabela de preços define a política aplicada aos próximos pedidos; sem vínculo específico, vale a Tabela padrão. Ao selecionar a cliente e o produto, o pedido mostra a tabela e preenche o preço correspondente automaticamente. O preço e a tabela ficam preservados no pedido mesmo depois de reajustes. Há Venda e Consignado, itens bonificados, desconto em valor ou percentual e comprovante após finalizar. No celular, abrir o teclado desloca somente o card uma única vez, após o teclado estabilizar, para manter o campo ativo visível, inclusive o desconto; o fundo do modal continua cobrindo toda a tela. Fechar o teclado devolve o card à posição original sem apagar o preenchimento.
