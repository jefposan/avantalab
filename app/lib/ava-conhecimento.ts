 ...
 */
// Revisado na versão 1.6.0.84.130: o contraste da Central de Consultas mudou
// sem alterar os fluxos orientados pela Ava.
...
- A Central de Consultas fica na rota pública isolada /consulta. Nesta primeira versão, somente a consulta cadastral de CNPJ está disponível por meio do CNPJ.ws; o resultado pode ser impresso, não cadastra a empresa e ainda não pode ser salvo porque a rota não recebe o contexto seguro de empresa ativa. CPF, crédito, protestos, restrições e consulta completa aparecem apenas como Em breve.
