...
- Um item ativo fica **Em estudo** enquanto **Disponível no catálogo** estiver desmarcado: pode ser organizado e precificado internamente, mas não aparece na divulgação. Ao marcar a disponibilidade, confirme preço de venda e os dados fiscais solicitados. Código interno repetido não pode ser salvo; a Gestão avisa e coloca o cursor no campo para correção.
