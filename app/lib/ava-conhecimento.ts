 ...
 */
// Revisado na versão 1.6.0.84.56: sessão restaurada no app abre o portal nativo; web e PWAs preservam seus fluxos.
...
NAVEGAÇÃO E PERFIS
- No aplicativo Capacitor, login, cadastro, Google e recuperação usam a entrada única da conta AvantaLab; na Gestão Web e nos PWAs, as telas atuais permanecem. O cadastro solicita o perfil inicial Empresa ou Pessoal e os respectivos dados, inclusive ao continuar com Google. Depois de autenticar no aplicativo, o usuário escolhe Gestão ou Vendas e o perfil autorizado. O perfil financeiro é criado e configurado somente quando a Gestão é escolhida; solicitar vínculo ao Vendas não cria outra conta, senha ou perfil financeiro.
...
- No aplicativo Capacitor, login, cadastro, Google e recuperação usam a entrada única da conta AvantaLab; o PWA mantém sua tela atual. O cadastro solicita o perfil inicial Empresa ou Pessoal e os respectivos dados, inclusive ao continuar com Google. Depois de autenticar no aplicativo, o usuário escolhe Gestão ou Vendas e o perfil autorizado. A configuração financeira só ocorre quando a Gestão é escolhida; vincular o Vendas por código preserva a mesma conta e senha sem criar perfil financeiro. Depois da escolha aparece Preparando acesso; dentro da Gestão, Menu > Ir para Vendas e o atalho de mesmo nome abrem diretamente o outro sistema sem novo login.
...
- A escolha de plataforma aparece na entrada após o login. Depois que um sistema foi aberto, a navegação interna permite trocar para o outro destino autorizado sem autenticar novamente.
...
- No aplicativo Capacitor, a entrada única autentica a conta AvantaLab e depois mostra Gestão, Vendas e os perfis autorizados; o PWA mantém sua tela atual. O cadastro solicita o perfil inicial Empresa ou Pessoal e seus dados, inclusive com Google; isso não cria perfil financeiro enquanto a Gestão não for escolhida. Quem não possui acesso ao Vendas pode solicitar vínculo com o código da empresa sem criar outra conta. Depois da escolha aparece Preparando acesso. Dentro do Vendas, Ir para Gestão fica no canto direito do header fixo da sala de botões. Ao tocar, ele lista todos os perfis ativos da Gestão vinculados à conta; o usuário escolhe um perfil e confirma antes de abrir a Gestão. Ir para Gestão também pode ser configurado como atalho inferior. A troca preserva a sessão e abre o perfil escolhido; vendedores sem papel de gestor não recebem essa opção.
...
- Pagamentos registra recebimentos, desconto, data e forma. Pelo botão +, Lançar pagamento abre a seleção de cliente; o campo Valor pago recebe foco. Editar ou excluir um pagamento recalcula o saldo e relatórios. Os campos de data de pedido e pagamento têm rótulo centralizado e data destacada; toque na data para abrir o calendário. Comprovantes podem ser abertos e editados pelas listas do cliente. Depois de concluir e fechar o comprovante, o Vendas retorna a Pagamentos quando o lançamento começou nessa tela; se começou pela ficha da cliente, retorna a Clientes.
