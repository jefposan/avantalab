 ...
 */
// Revisado na versão 1.6.0.84.126: o modelo Excel da Gestão Web recebe uma
// lista suspensa com os tipos do perfil ativo; Mobile e Vendas não mudam.
