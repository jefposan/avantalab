...
// Revisado na versão 1.13.0.02: a precificação interna da Gestão foi separada
// do catálogo de divulgação e dos pedidos do AvantaVendas. Ao incluir, editar, confirmar ou excluir uma
...
// tabela e o preço efetivamente usados no pedido.
...
- Novo pedido pode iniciar em Clientes (cliente já definido) ou em Pedidos (selecionar cliente). Ao selecionar um produto, o pedido começa com o preço sugerido publicado no catálogo de divulgação e o vendedor pode editar esse valor manualmente antes de inserir o item. Tabelas internas de Custos e Precificação não interferem neste fluxo. Há Venda e Consignado, itens bonificados, desconto em valor ou percentual e comprovante após finalizar. No celular, abrir o teclado desloca somente o card uma única vez, após o teclado estabilizar, para manter o campo ativo visível, inclusive o desconto; o fundo do modal continua cobrindo toda a tela. Fechar o teclado devolve o card à posição original sem apagar o preenchimento.
