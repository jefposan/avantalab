...
- Ao confirmar um pagamento, o Vendas bloqueia uma segunda confirmação, confere no servidor todos os pedidos e pagamentos da cliente e só então atualiza o saldo e libera o comprovante. Os comprovantes usam fonte ampliada para título, itens e valores; o Top 10 Clientes do Dashboard também privilegia leitura. Ao compartilhar, a imagem usa cabeçalho com empresa, cliente e data, sem os botões da tela, e destaca o valor do lançamento e o saldo atual em faixas próprias. O rodapé e a mensagem identificam o comprovante e a cliente, sem assinatura do sistema. Se qualquer confirmação falhar, o formulário permanece aberto e nenhum comprovante é exibido.
