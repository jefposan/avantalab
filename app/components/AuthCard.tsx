    ...
    <span className="text-2xl font-black leading-none">!</span>
      ...
      <section className="relative z-10 grid min-h-[100dvh] grid-rows-[minmax(0,1fr)_auto_minmax(0,1fr)] items-stretch px-4 pb-8 pt-0 lg:flex lg:min-h-screen lg:items-center lg:px-20 lg:py-10">
        <Image
          ...
          height={72}
          priority
          className="pointer-events-none absolute left-1/2 top-1/2 hidden h-auto w-[clamp(136px,32vw,248px)] max-w-[66%] -translate-x-1/2 -translate-y-1/2 object-contain lg:fixed lg:block"
        />
        <div className="contents lg:block lg:w-full lg:max-w-7xl">
          ...
          <div className={`relative z-20 w-full rounded-3xl border p-4 shadow-2xl lg:mx-0 lg:max-w-md lg:-translate-y-5 lg:border-white/30 lg:bg-white/70 lg:p-8 lg:backdrop-blur-xl ${
            loginMobilePadrao ? 'row-start-2 mx-auto w-[80%] max-w-[336px] self-center rounded-[18px] border-white/70 bg-white/[.30] p-4 shadow-[0_18px_45px_rgba(0,31,60,0.22),inset_0_1px_0_rgba(255,255,255,0.45)] backdrop-blur-xl backdrop-saturate-[1.35] [@media(pointer:fine)]:mx-0' : 'row-start-2 mx-auto w-full max-w-md self-center border-white/20 bg-white/10'
          }`}>
            <>
