...
const formatarNomeProduto = (valor: string) => {
  const texto = String(valor || '').replace(/^\s+/, '').replace(/\s{2,}/g, ' ').toLocaleLowerCase('pt-BR');
