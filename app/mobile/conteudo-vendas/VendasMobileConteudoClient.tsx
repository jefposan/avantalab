...
export default function VendasMobileConteudoClient({ empresaId }: { empresaId: string }) {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (!temPermissao) setErro('O módulo Conteúdo AvantaVendas não está instalado neste perfil ou seu acesso não permite publicar conteúdos.');
      setProgresso(100);
