...
function clienteParaTela(customer: Record<string, any>) {
  ...
  return {
    ...
    fiscal: customer.stateRegistrationIndicator === 'contribuinte_icms' ? 'Contribuinte ICMS' : customer.stateRegistrationIndicator === 'contribuinte_isento' ? 'Contribuinte isento' : 'Não contribuinte',
...
function clienteParaApi(customer: Record<string, any>) {
  return {
    ...
    stateRegistrationIndicator: customer.fiscal === 'Contribuinte ICMS' ? 'contribuinte_icms' : customer.fiscal === 'Contribuinte isento' ? 'contribuinte_isento' : 'nao_contribuinte',
    consumerFinal: customer.consumerFinal === true,
