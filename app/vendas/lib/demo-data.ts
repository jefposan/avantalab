...
export type ClientRecord = {
  ...
  fiscal: 'Contribuinte ICMS' | 'Consumidor final' | 'Não contribuinte';
  email: string;
  phone: string;
  contactName: string;
  cep: string;
...
export const clients: ClientRecord[] = [
  { id: 'CLI-0001', name: 'Clínica Essenza Ltda.', legalName: 'Clínica Essenza Saúde e Bem-estar Ltda.', tradeName: 'Clínica Essenza', document: '48.210.380/0001-15', profile: 'Pessoa jurídica', stateRegistration: '110.042.490.114', municipalRegistration: '8.765.432-1', fiscal: 'Contribuinte ICMS', email: 'financeiro@essenza.demo', phone: '(11) 3456-7890', contactName: 'Ana Essenza', cep: '01310-100', street: 'Avenida Paulista', number: '1000', complement: 'Conjunto 42', district: 'Bela Vista', cityName: 'São Paulo', cityCode: '3550308', state: 'SP', city: 'São Paulo/SP', seller: 'Marina', paymentTerms: '14 dias', orders: 18, revenue: 28450, lastPurchase: '26/08/2026', status: 'Ativo' },
  { id: 'CLI-0002', name: 'Studio Bela Pele', legalName: 'Bela Pele Estética Profissional Ltda.', tradeName: 'Studio Bela Pele', document: '11.222.333/0001-81', profile: 'Pessoa jurídica', stateRegistration: 'Isento', municipalRegistration: '456.778-2', fiscal: 'Consumidor final', email: 'contato@belapele.demo', phone: '(19) 3344-2211', contactName: 'Beatriz Lima', cep: '13010-111', street: 'Rua Barão de Jaguara', number: '620', complement: 'Sala 8', district: 'Centro', cityName: 'Campinas', cityCode: '3509502', state: 'SP', city: 'Campinas/SP', seller: 'Caio', paymentTerms: 'À vista', orders: 11, revenue: 16220, lastPurchase: '25/08/2026', status: 'Ativo' },
  { id: 'CLI-0003', name: 'Farmácia Central', legalName: 'Farmácia Central de Sorocaba Ltda.', tradeName: 'Farmácia Central', document: '17.552.694/0001-72', profile: 'Pessoa jurídica', stateRegistration: '669.327.441.110', municipalRegistration: '091.228-7', fiscal: 'Contribuinte ICMS', email: 'compras@farmaciacentral.demo', phone: '(15) 3211-9080', contactName: 'Carlos Nogueira', cep: '18010-160', street: 'Rua da Penha', number: '388', complement: '', district: 'Centro', cityName: 'Sorocaba', cityCode: '3552205', state: 'SP', city: 'Sorocaba/SP', seller: 'Marina', paymentTerms: '28 dias', orders: 23, revenue: 41280, lastPurchase: '25/08/2026', status: 'Ativo' },
  { id: 'CLI-0004', name: 'Espaço Harmonia', legalName: 'Espaço Harmonia Terapias Integradas Ltda.', tradeName: 'Espaço Harmonia', document: '52.803.176/0001-85', profile: 'Pessoa jurídica', stateRegistration: 'Isento', municipalRegistration: '778.201-9', fiscal: 'Consumidor final', email: 'administrativo@harmonia.demo', phone: '(11) 4587-4400', contactName: 'Helena Martins', cep: '13201-000', street: 'Rua do Rosário', number: '144', complement: '', district: 'Centro', cityName: 'Jundiaí', cityCode: '3525904', state: 'SP', city: 'Jundiaí/SP', seller: 'Caio', paymentTerms: '14 dias', orders: 9, revenue: 13810, lastPurchase: '24/08/2026', status: 'Ativo' },
  { id: 'CLI-0005', name: 'Hotel Serra Azul', legalName: 'Serra Azul Hotelaria e Turismo Ltda.', tradeName: 'Hotel Serra Azul', document: '06.184.529/0001-99', profile: 'Pessoa jurídica', stateRegistration: '', municipalRegistration: '102.447-0', fiscal: 'Não contribuinte', email: 'compras@serraazul.demo', phone: '(12) 3663-1150', contactName: 'Eduardo Campos', cep: '12460-000', street: 'Avenida Macedo Soares', number: '510', complement: '', district: 'Capivari', cityName: 'Campos do Jordão', cityCode: '3509700', state: 'SP', city: 'Campos do Jordão/SP', seller: 'Marina', paymentTerms: '30 dias', orders: 7, revenue: 22150, lastPurchase: '22/08/2026', status: 'Revisar cadastro' },
];
