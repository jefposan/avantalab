...
> pública da Gestão Web; sem impacto operacional no AvantaVendas.
...
> Revisão 1.38.0.04: o refinamento visual da barra de ações pertence a Custos
> e Precificação na Gestão Web; sem alteração operacional no AvantaVendas.

> Revisão 1.38.0.03: o salvar unificado e a proteção contra descarte pertencem
> a Custos e Precificação na Gestão Web; sem alteração operacional no AvantaVendas.

> Revisão 1.38.0.02: o menu flutuante de Produtos e Serviços pertence a Custos
> e Precificação na Gestão Web; sem alteração operacional no AvantaVendas.
...
> otimizado para rede móvel. Não muda a pergunta, o resultado, a confirmação ou
> as regras operacionais do AvantaVendas.
>
...
> pertence ao PWA Operações de Campo; não altera o fluxo do AvantaVendas.
...
> modo escuro, o símbolo permanece branco.

> Revisão 1.16.0.12-av140: recursos do AvantaVendas renovados com o refinamento
> aprovado do símbolo de informação.
...
> Revisão 1.15.0.07-av130: recursos de voz e Sala renovados com o ícone maior
> de sugestões.
...
> Revisão 1.12.1-av102: refinamento visual da ação de seleção múltipla.
...
> da movimentação, e os avisos aparecem acima dos cards.
...
> aplicada; sem alteração operacional no Vendas Mobile.
...
> refinada; sem alteração operacional no AvantaVendas.
...
> visualmente; sem alteração operacional no AvantaVendas.

> Revisão 1.9.0.01: a navegação pública da Gestão Financeira foi reorganizada
> horizontalmente; sem alteração operacional no AvantaVendas.

> Revisão 1.9.0: a landing pública foi separada entre Laboratório de Marcas e
> Gestão Financeira; sem alteração operacional no AvantaVendas.
...
> disponibilidade futura, sem alterar o funcionamento do aplicativo.
...
> Revisão 1.7.3.28: confirmação de cópia de links no AvantaProjetos não altera
> o funcionamento do AvantaVendas.
...
> materiais publicados no AvantaVendas não mudaram.
...
> Revisão 1.6.1.141: sem impacto operacional no AvantaVendas; a habilitação
> facial do Controle de Ponto passou a respeitar cada funcionário.

> Revisão 1.6.1.140: sem impacto operacional no AvantaVendas; a câmera facial
> do Controle de Ponto ganhou orientações de enquadramento.
>
...
> Revisão 1.6.1.116: formato e edição de aportes são exclusivos da Gestão;
> sem impacto operacional no AvantaVendas.
...
> estabilização do build iOS; sem impacto operacional no AvantaVendas.

> Revisão 1.6.1.107.61: remoção da borda e da sombra lateral do card de
> identificação da Gestão Mobile; sem impacto operacional no AvantaVendas.
...
> e Recebimentos Presenciais; sem impacto operacional no AvantaVendas.
...
> relatório web do Controle de Ponto; sem impacto operacional no AvantaVendas.
...
> lançamentos na Gestão Mobile; sem impacto operacional no AvantaVendas.
...
Este manual vale para a Ava aberta em `/avantavendas`, inclusive pelo endereço
`vendas.avantalab.com.br`. Durante a migração, `/mobile/vendas` permanece apenas
como contingência. A Ava deve resolver a dúvida dentro do Vendas sempre que a
função existir ali.
