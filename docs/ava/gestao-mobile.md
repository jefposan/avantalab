...
> Revisão 1.14.3.16.05: compactação visual aplicada somente à revisão de regras
> fiscais em Vendas e Serviços Web; sem impacto operacional na Gestão Mobile.
...
> Revisão 1.14.3.16.01: verificação da conexão fiscal alterada somente em
> Vendas e Serviços Web; sem impacto operacional na Gestão Mobile.
