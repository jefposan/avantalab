...
> e Precificação na Gestão Web; sem alteração operacional na Gestão Mobile.
...
> Revisão 1.38.0.02: o ajuste do menu flutuante de ações pertence a Custos e
> Precificação na Gestão Web; sem alteração operacional na Gestão Mobile.
...
> Centros de custo por plano serão concluídas nas próximas etapas; até então,
> oriente apenas os comandos já disponíveis no aplicativo.
...
> de custo** pertence à Gestão Web; sem impacto operacional na Gestão Mobile.
...
> PWA não altera a operação da Gestão Mobile.
...
> de Operações de Campo não altera a operação da Gestão Mobile.
...
> somente ao AvantaVendas; sem impacto operacional na Gestão Mobile.
...
> ao banco do AvantaVendas; sem impacto operacional na Gestão Mobile.
...
> **Controle de Ponto** pertence à Gestão Web; sem alteração operacional na
> Gestão Mobile.
...
> página; sem alteração operacional na Gestão Mobile.
...
> Notícias, Divulgação e Catálogo. O AvantaVendas é independente: a tela não
> aprova nem bloqueia seu uso, seus pedidos ou seus dados financeiros.
>
...
> do perfil. A aprovação libera apenas o vínculo de conteúdo da equipe; o
...
> aplicada; sem alteração operacional na Gestão Mobile.
...
> refinada; sem alteração operacional na Gestão Mobile.
...
> como disponibilidade futura, sem alterar o funcionamento da Gestão Mobile.
...
> Revisão 1.7.3.33: ajuste da área de transferência exclusivo do
> AvantaProjetos Web; sem alteração operacional na Gestão Mobile.

> Revisão 1.7.3.32: correção do acionamento de cópia exclusiva do
> AvantaProjetos Web; sem alteração operacional na Gestão Mobile.
...
> Revisão 1.7.3.29: correção de cópia de links exclusiva do AvantaProjetos Web;
> sem alteração operacional na Gestão Mobile.

> Revisão 1.7.3.28: confirmação de cópia de links é exclusiva do
> AvantaProjetos Web; sem alteração operacional na Gestão Mobile.

> Revisão 1.7.3.27: links renováveis de Projetos são exclusivos da Gestão Web;
> sem alteração operacional na Gestão Mobile.
